...
col = ['wisdm', 'activity', 'timestamp', 'x-axis', 'y-axis', 'z-axis']
wisdm = pd.read_csv('data_1608_accel_watch.txt', sep=',', on_bad_lines='skip', header = None, names = col)
# wisdm = pd.read_csv('data_1608_accel_phone.txt', sep=',', on_bad_lines='skip', header = None, names = col)
...
teeth = wisdm[wisdm['activity'] == 'G'].head(3605)
soup = wisdm[wisdm['activity'] == 'H'].head(3605)
chips = wisdm[wisdm['activity'] == 'I'].head(3605)
pasta = wisdm[wisdm['activity'] == 'J'].head(3605)
drinking = wisdm[wisdm['activity'] == 'K'].head(3605)
sandwich = wisdm[wisdm['activity'] == 'L'].head(3605)

# balancing for phone data
# teeth = wisdm[wisdm['activity'] == 'G'].head(3572)
# soup = wisdm[wisdm['activity'] == 'H'].head(3572)
# chips = wisdm[wisdm['activity'] == 'I'].head(3572)
# pasta = wisdm[wisdm['activity'] == 'J'].head(3572)
# drinking = wisdm[wisdm['activity'] == 'K'].head(3572)
# sandwich = wisdm[wisdm['activity'] == 'L'].head(3572)
...
print("Accuracy of model trained on WISDM User 8:", accuracy)
